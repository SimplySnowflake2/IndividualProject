...
void setup() {
  ...
  app1 = new Button("App 1", 68, 190, #FFC4E4, 0);
  app2 = new Button("App 2", width/2 - 75, 190, #FFCB86, 0);
  app3 = new Button("App 3", 382, 190, #FFF386, 0);
  app4 = new Button("App 4", 68, 250, #B4EDCB, 0);
  app5 = new Button("App 5", width/2 - 75, 250, #BEE7F5, 0);
  app6 = new Button("App 6", 382, 250, #E5BEF5, 0);
